o2-analysis-lf-lithium4analysis -b --configuration json://configuration_mc.json --shm-segment-size 750000000000 --aod-memory-rate-limit 50000000000|
    ...
    o2-analysis-pid-tof-full -b --configuration json://configuration_mc.json --shm-segment-size 750000000000 --aod-memory-rate-limit 50000000000 --aod-writer-json OutputDirector.json